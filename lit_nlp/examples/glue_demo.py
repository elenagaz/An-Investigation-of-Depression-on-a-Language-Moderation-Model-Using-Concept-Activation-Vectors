...
def main(argv: Sequence[str]) -> Optional[dev_server.LitServerType]:
  ...
  if _QUICKSTART.value:
    ...
    logging.info("Quick-start mode; overriding --models and --max_examples.") # loffing info is output on the console
  ...
  for model_string in _MODELS.value:
    ...
    # containing 'https://'
    logging.info("models: " + ", ".join(_MODELS.value))
